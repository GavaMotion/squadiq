...
export const DRILLS = [
  {
    ...
    videoUrl: 'https://www.youtube.com/watch?v=d_4T1DMBy1A',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/watch?v=yi7bSqDwH20',
    diagram: 'compass',
    variations: [
  ...
  },
  {
    ...
    description:
      'Pairs in a 10×15-yard channel. Attacker dribbles forward at half speed; defender stays goal-side and mirrors the attacker\'s movement without tackling. Focus is purely on body shape, footwork, and staying balanced. After 30 seconds, switch roles. Progress to full speed and live tackling once positioning is solid.',
    category: 'defending',
    minDivision: '8U',
    phase: 'skill-work',
    duration: 10,
    ...
    equipment: ['balls', 'cones'],
    coachingPoints: [
      'Stay goal-side at all times — the goal is your reference point',
      'Knees bent, low stance — ready to change direction',
      'Patient feet — do not lunge or commit to a tackle early',
      'Show the attacker to the sideline, away from goal',
      'Keep an arm\'s length distance — close enough to pressure, far enough to react',
    ],
    variations: [
      'Allow the defender to tackle once positioning is solid',
      'Add a small goal at the end — attacker tries to score, defender prevents',
      'Reduce channel width to 5 yards for more pressure',
    ],
  },
]
